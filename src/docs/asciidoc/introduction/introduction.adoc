...
In addition to these services, you can develop your business code directly on ZetaPush using a proprietary language called ZMS (ZetaPush Macro Script).
...
image:schemas/ZetaPushV2.png[ZetaPush v2 schema]
...
image:schemas/ZetaPushCeltia.png[ZetaPush Celtia schema]
